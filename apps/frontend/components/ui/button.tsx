...
const variantClass = {
  ...
  ghost: 'border border-transparent bg-transparent text-slate-700 hover:bg-slate-50 disabled:text-slate-400',
  outline: 'border border-slate-200 bg-white text-slate-700 hover:border-brand-200 hover:text-brand-700 disabled:bg-slate-100 disabled:text-slate-400',
