...
export function UserAvatar({ className, name, photoUrl }: { className?: string; name: string; photoUrl?: string | null }) {
  ...
  return (
    <span className={cn('grid size-16 shrink-0 place-items-center overflow-hidden rounded-[1.35rem] border border-blue-100 bg-brand-600 text-xl font-black text-white', className)}>
